...
import EntertainmentImg from "../common/eventCards/EntertainmentImgCard";
import EntertainmentVideo from "../common/eventCards/EntertainmentVideoCard";


class EntertainmentWithGrid extends Component {
    constructor(props) {
        super(props);
    }
...
export default EntertainmentWithGrid;
